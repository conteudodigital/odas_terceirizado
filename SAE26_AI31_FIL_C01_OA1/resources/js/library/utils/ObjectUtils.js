export class ObjectUtil {
  ...
  static bringToFront(gameObject) {
    ...
    if (
      ...
      gameObject.container instanceof Phaser.GameObjects.Container
    ) {
      gameObject.container.setDepth(this.LAYER_DEPTHS.STATEMENT);
      //console.log('bringToFront: Container trazido para a frente com depth', this.LAYER_DEPTHS.STATEMENT);
    }
    // Verifica se o objeto é um GameObject válido
      ...
      //console.log('bringToFront: GameObject trazido para a frente com depth', this.LAYER_DEPTHS.STATEMENT);
    }
