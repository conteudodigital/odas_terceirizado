...
export class TextFrameHUD extends Phaser.GameObjects.Container {
  ...
  constructor(
    ...
    const padX = 270;
    const padY = Math.round(frameHeight * 0.6);
    ...
    this.personagemName.x = this.frame.width + 40;
    ...
    this.btNext.x = frameWidth - padX - this.btNext.displayWidth / 2 - 400;
